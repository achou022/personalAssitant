# cloned from https://github.com/SaralTayal123/Object-Finding-Rover
...
#        startTime = time.time()
    ...
    if((tf_in.find('person') !=-1) and (currentDetection == "face")):
        ...
        # face bounding box size determined
        avgFace = avgFace / 3.0
        #print("hi3")
...
if __name__ == "__main__":
    print ("starting rover main script")
    ...
    while True:
        if (needToSleep == False):
            print ("needToSleep:"+needToSleep + "/starting main logic loop")
            ...
            if (currentDetection == "cup" or currentDetection == "banana"): #you can add your additional detection objects here
                ...
                if (motor_direction == "left"):
                    ...
                    if (distance > 20 and distance <35):
                        ...
                        print('BUG')
            # this should stop and put robot in neutral position
            if(distance < 10):
                # object detected, entering neutral position
                print("object detected")
                print("breaking for object avoidance")
                roboclaw.SpeedAccelDeccelPositionM1M2(address, 0,0,0,0,1)
                # roboclaw.BackwardM1(address, 0)
